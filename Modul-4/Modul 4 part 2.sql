...
-- Latihan Mandiri
-- 1. Menlihat daftar nama produk yang total jumlah produk terjual per kelompok nama produk adalah diatas nilai 4.
...
-- 3. Melihat daftar kelompok nama produk dan total niali penjualan (harga dikalikan jumlah dikurangi diskon)
-- dengan dan urutkan bedasarkan nilai penjualan terbesar
